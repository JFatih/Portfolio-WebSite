  ...
  return (
    <section className="w-screen bg-[#F4F4F4] overflow-hidden relative">
      ...
      <article className="w-4/6 flex justify-between mx-auto">
        <div className="w-[508px] rounded-xl bg-white shadow-[10px_10px_0px_0px_rgba(0,0,0,0.3)] p-[40px] mb-[100px]">
          <header>
        ...
        <div className="w-[476px] p-[40px] text-start">
          <p className="text-[24px] mb-[20px] relative z-50">
            ...
            <span className="absolute border rounded-md w-[90px] h-[18px] bg-[#82BBFF] left-[-10px] top-[20px] z-[-1]"></span>
          </p>
